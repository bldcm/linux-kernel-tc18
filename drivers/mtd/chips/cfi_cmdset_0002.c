	...
	case FL_ERASING:
		...
		for (;;) {
			...
			if (time_after(jiffies, timeo)) {
				...
				// Hr: try mtd: fix hang-up in cfi erase and read contention fix from 
				// https://github.com/torvalds/linux/commit/100f2341e305f98de3aa12fb472771ab029cbda7
				// (Changed on 2011-05-19 in Linux kernel)
